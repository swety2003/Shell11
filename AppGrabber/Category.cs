...
namespace AppGrabber
{
    ...
    public class Category : IList<ApplicationInfo>, INotifyPropertyChanged, INotifyCollectionChanged
    {
        ...
        public Category()
        {
            Name = "Unknown";
            ShowInMenu = true;
            appsList = new List<ApplicationInfo>();
        ...
        private void RemoveFromAllCategory(ApplicationInfo item)
        {
            ...
            if (Type != AppCategoryType.All && Type != AppCategoryType.QuickLaunch)
                ParentCategoryList.GetSpecialCategory(AppCategoryType.All).Remove(item);
        }
        ...
        public void Add(ApplicationInfo ai)
        {
            ...
            if (Type != AppCategoryType.All && Type != AppCategoryType.QuickLaunch)
                ParentCategoryList.GetSpecialCategory(AppCategoryType.All).Add(ai);
        }
        ...
        public void Insert(int index, ApplicationInfo item)
        {
            ...
            // add corresponding item to the all category (excluding quick launch apps because they are essentially duplicates)
            if (Type != AppCategoryType.All && Type != AppCategoryType.QuickLaunch)
                ParentCategoryList.GetSpecialCategory(AppCategoryType.All).Insert(0, item);
        }
